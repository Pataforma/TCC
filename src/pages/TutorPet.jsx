  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode && editPetId) {
        ...
        const { data, error: rpcError } = await supabase.rpc('insert_pet_bypass_rls', {
          nome_pet: nome,
          raca_pet: raca,
      ...
      setMensagem(editMode ? "Pet atualizado com sucesso!" : "Pet cadastrado com sucesso!");
      resetForm();
      fetchPets(); // Atualiza a lista
    } catch (error) {
      console.error("Erro ao salvar pet:", error);
      setMensagem(`Erro ao ${editMode ? "atualizar" : "cadastrar"} pet: ${error.message}`);
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="row">
              <div className="col-lg-8 mx-auto">
                <div className="card shadow p-4 mb-4">
                  <h2 className="mb-4">{editMode ? "Editar Pet" : "Cadastrar Novo Pet"}</h2>
                    ...
                    <div className="d-flex gap-2 mt-4">
                      ...
                      >
                        {loading || uploading ? (
                          ...
                          editMode ? "Atualizar Pet" : "Cadastrar Pet"
                        )}
                      </button>
                      {editMode && (
                        <button
                          ...
                          <div className="card h-100">
                            ...
                            <div className="card-body">
                              ...
                              <div className="card-text">
                                ...
                                {pet.idade && <p><strong>Idade:</strong> {pet.idade} ano(s)</p>}
                                {pet.peso && <p><strong>Peso:</strong> {pet.peso} kg</p>}
                                {pet.nfc_id && <p><strong>ID NFC:</strong> {pet.nfc_id}</p>}
                              </div>
                            </div>
