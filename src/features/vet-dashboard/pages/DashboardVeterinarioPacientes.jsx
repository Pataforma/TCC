...
// Removido: ModalNovoPaciente - veterinários não criam mais pacientes diretamente
...
const DashboardVeterinarioPacientes = () => {
  ...
  // Removido: showModalNovoPaciente - veterinários não criam mais pacientes
  ...
  return (
    <DashboardLayout tipoUsuario="veterinario" nomeUsuario={user?.nome}>
      <div className="container-fluid">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <div className="d-flex gap-2">
            ...
            {/* Removido: Veterinários não criam mais pacientes diretamente */}
            {/* Os pacientes são criados pelos tutores ao solicitar agendamentos */}
          </div>
        </div>
      ...
      {/* Removido: Modal de criação de pacientes */}
      {/* Os pacientes são criados pelos tutores ao solicitar agendamentos */}
