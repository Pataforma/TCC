...
const DashboardTutorPerfil = () => {
    ...
    const fetchPerfil = async () => {
      ...
      try {
        ...
        if (userData) {
          ...
          // Usuário ainda não tem perfil completo
          if (user) {
            setNome(user.nome || "");
            setEmail(user.email || "");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userData = {
        nome,
        telefone,
        tipo_usuario: usuario?.tipo_usuario || "tutor",
      };

      const updatedUser = await api.put("/usuarios/perfil", userData);
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await api.put("/usuarios/perfil", { status: "inativo" });
