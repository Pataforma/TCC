...
const RedeSocial = lazy(() => import("./pages/RedeSocial"));
const RedeSocialVeterinario = lazy(() => import("./pages/RedeSocialVeterinario"));
...
const SolicitacoesAgendamentoPage = lazy(() =>
  import("./features/vet-dashboard/pages/SolicitacoesAgendamentoPage")
);
      ...
      <div key={location.pathname} className="fade-in">
        <Suspense fallback={<PageLoader />}>
          <Routes location={location}>
            ...
            <Route path="/rede-social/veterinario/:id" element={<RedeSocialVeterinario />} />
            ...
            />
            <Route
              path="/dashboard/veterinario/solicitacoes"
              element={
                <VeterinarioRoute>
                  <SolicitacoesAgendamentoPage />
                </VeterinarioRoute>
              }
            />
            <Route
